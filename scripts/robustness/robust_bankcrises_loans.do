/*
 Robustness: are the results on bank lending robust to controlling for banking crises?
*/
clear all
...
global bankvars "capitaltoassets_lag credittodeposits_lag bankconcentr_lag liqratio_lag crisis_lag L.dlrloans_w"
...
xtabond2 $y $x $politvars y1-y12 $macrolags $bankvars, ///
ivstyle($x $politvars y1-y12 $macrolags) gmmstyle($bankvars, ///
laglimits(. 4) collapse) robust small noleveleq
eststo cb4
estadd local estmethod "AB"
estadd local yearfe "Yes"
estadd local countryfe "Yes"
...
#delimit ;
estout baseline2 baseline3 baseline4 cb2 cb3 cb4 ce2 ce3 ce4 rl2 rl3 rl4 using ./output/tables/robust_crises_loans.tex,
			style(tex)
