/*
 Robustness: do the results on bank lending change if we drop small countries?
*/
...
#delimit ;
estout baseline2 baseline3 baseline4 cb2 cb3 cb4 ce2 ce3 ce4 rl2 rl3 rl4 using ./output/tables/robust_nosmall_loans.tex,
			style(tex)
