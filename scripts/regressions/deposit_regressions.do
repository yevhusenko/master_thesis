...
/* Regressions to estimate how bank deposit accumulation reacts to 
	elections. 
...
estadd local yearfe "Yes"
estadd local countryfe "Yes"
test $x $politvars $macrolags $bankvars y1 y2 y3 y4 y5 y6 y7 y8 y9 y10 y11 y12
...
#delimit ;
estout baseline* using ./output/tables/baselinereg.tex,
			style(tex)
			...
			numbers
			collabels(none)
			varlabels(L.dlrdeposits_hhs_w "$\text{Real HH deposit growth}_{it-1}$")
			starl(* 0.1 ** 0.05 *** 0.01)
			drop(y* _cons)
			prehead(\begin{longtable}{m{8cm}*{4}{c}}
					\caption{Political Uncertainty and Bank Deposit Growth: Baseline Results\label{baselinedeposits}}\\
					\toprule
					&\multicolumn{4}{c}{$\text{Real HH deposit growth}_{it}$} \\ \cmidrule(lr){2-5})
			posthead(\midrule\endfirsthead
					\multicolumn{5}{r}{\textit{Table~\ref{baselinedeposits} continued}} \\
...
estout cb* using ./output/tables/cbreg.tex,
			...
			drop(y* _cons)
			prehead(\begin{longtable}{m{8cm}*{4}{c}}
					\caption{Political Uncertainty and Bank Deposit Growth: Checks \& Balances \label{cbdeposits}}\\
					\toprule
					&\multicolumn{4}{c}{$\text{Real HH deposit growth}_{it}$} \\ \cmidrule(lr){2-5})
			posthead(\midrule\endfirsthead
					\multicolumn{5}{r}{\textit{Table~\ref{baselinedeposits} continued}} \\
...
estout di* using ./output/tables/direg.tex,
			...
			drop(y* _cons)
			prehead(\begin{longtable}{m{8cm}*{4}{c}}
					\caption{Political Uncertainty and Bank Deposit Growth: Deposit Insurance \label{dideposits}}\\
					\toprule
					&\multicolumn{4}{c}{$\text{Real HH deposit growth}_{it}$} \\ \cmidrule(lr){2-5})
			posthead(\midrule\endfirsthead
					\multicolumn{5}{r}{\textit{Table~\ref{baselinedeposits} continued}} \\
...
estout rl* using ./output/tables/rlreg.tex,
			...
			drop(y* _cons)
			prehead(\begin{longtable}{m{8cm}*{4}{c}}
					\caption{Political Uncertainty and Bank Deposit Growth: Political Affiliation of the Incumbent \label{rldeposits}}\\
					\toprule
					&\multicolumn{4}{c}{$\text{Real HH deposit growth}_{it}$} \\ \cmidrule(lr){2-5})
			posthead(\midrule\endfirsthead
					\multicolumn{5}{r}{\textit{Table~\ref{baselinedeposits} continued}} \\
...
estout ce* using ./output/tables/cereg.tex,
			...
			drop(y* _cons)
			prehead(\begin{longtable}{m{8cm}*{4}{c}}
					\caption{Political Uncertainty and Bank Deposit Growth: Close Elections \label{cedeposits}}\\
					\toprule
					&\multicolumn{4}{c}{$\text{Real HH deposit growth}_{it}$} \\ \cmidrule(lr){2-5})
			posthead(\midrule\endfirsthead
					\multicolumn{5}{r}{\textit{Table~\ref{baselinedeposits} continued}} \\
